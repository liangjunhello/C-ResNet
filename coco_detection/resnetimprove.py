...
def net_construct(blockid,layers,num_class=1000):

    if(blockid==0):return ResNet(BasicBlock, layers,num_classes=num_class)
    elif(blockid==1):return ResNet(Bottleneck, layers,num_classes=num_class)
    elif(blockid==2):return ResNet(c_BasicBlock_A1, layers,num_classes=num_class)
    elif(blockid==3):return ResNet(c_BasicBlock_A, layers,num_classes=num_class)
    elif(blockid==4):return ResNet(c_BasicBlock_A2, layers,num_classes=num_class)
    elif(blockid==5):return ResNet(c_Bottleneck_C1, layers,num_classes=num_class)
    elif(blockid==6):return ResNet(c_Bottleneck_C, layers,num_classes=num_class)
    elif(blockid==7):return ResNet(c_Bottleneck_B, layers,num_classes=num_class)
    elif(blockid==8):return ResNet(c_Bottleneck_B1, layers,num_classes=num_class)
    elif(blockid==9):return ResNet(c_Bottleneck_B2, layers,num_classes=num_class)
    elif(blockid==10):return ResNet(c_Bottleneck_B3, layers,num_classes=num_class)
    else:
        return ResNet(BasicBlock, layers,num_classes=num_class)



if __name__ == '__main__':
    net = net_construct(3,[1,2,1,1],91)
