...
## Example
We use cifar10 for the default data set, and -d for changing the data set :
- (0 Cifar10, 1 Cifar100, 2 Caltech101,3 Caltech256)

c_BasicBlock_A1 is the default Cross Block, change the Cross Block with the -b command :
